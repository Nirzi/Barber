# Generated by Django 5.1.1 on 2025-04-20 05:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новая'), ('approved', 'Подтверждена'), ('completed', 'Завершена'), ('canceled', 'Отменена')], default='new', max_length=50, verbose_name='Статус')),
